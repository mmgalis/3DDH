...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [26071.561421, 410654.272764, 199269.013566, 521152.183994], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:28992',
...
map.getView().fit([26071.561421, 410654.272764, 199269.013566, 521152.183994], map.getSize());
